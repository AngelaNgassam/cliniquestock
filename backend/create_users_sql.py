#!/usr/bin/env python
"""Script pour créer un pharmacien et un administrateur avec SQL direct"""
import os
import django
    ...
    with connection.cursor() as cursor:
        try:
            ...
            cursor.execute("""
                ...
                (nom, prenom, email, mot_de_passe, role, est_actif, date_creation, is_staff, is_superuser)
                VALUES (%s, %s, %s, %s, %s, %s, NOW(), %s, %s)
                RETURNING id;
            """, [nom, prenom, email, hashed_password, 'ADMINISTRATEUR', True, True, True])
    ...
    with connection.cursor() as cursor:
        try:
            ...
            cursor.execute("""
                ...
                VALUES (%s, %s, %s, %s, %s, %s, NOW(), %s, %s)
                RETURNING id;
            """, [nom, prenom, email, hashed_password, 'PHARMACIEN', True, False, False])
