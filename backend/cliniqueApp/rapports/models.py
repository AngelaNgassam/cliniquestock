...
class Rapport(models.Model):
    ...
    format = models.CharField(
        max_length=10, choices=FormatRapport.choices, default=FormatRapport.PDF
    )
...
# ✅ NOUVEAU : Logo de la clinique
class LogoClinique(models.Model):
    nom_clinique = models.CharField(max_length=200, default='Ma Clinique')
